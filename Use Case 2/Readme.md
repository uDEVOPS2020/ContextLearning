...
*Commands*: 
python causal_model.py dataset.txt
(or run the notebook)
java SEM.java
 
To replicate on a different subject, use Locust and monitoring scripts on the new subject, thus apply all the steps i) to iv) (possibly replace the input filenames) 
